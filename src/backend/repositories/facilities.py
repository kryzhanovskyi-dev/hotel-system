...
from backend.models.facilities import FacilitiesOrm, RoomsFacilitiesOrm
from backend.repositories.base import BaseRepository
from backend.repositories.mappers.mappers import FacilityDataMapper
from backend.schemas.facilities import RoomFacilitySchema
