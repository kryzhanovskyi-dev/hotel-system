...
from backend.repositories.mappers.mappers import RoomDataMapper, RoomWithRelsDataMapper
...
class RoomsRepository(BaseRepository):
    ...
    async def get_filtered_by_time(
        ...
        return [RoomWithRelsDataMapper.map_to_domain_entity(model) for model in res.unique().scalars().all()]
